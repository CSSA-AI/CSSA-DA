...
| [refusal-contract.md](refusal-contract.md) | The refusal contract test: relevant-but-answerless cases, the two executable criteria, why it is a release gate rather than a CI test, and the prompt change its first run forced |
